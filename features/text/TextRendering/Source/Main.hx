		...
		if (preloader.complete)
		{
			switch (context.type)
			{
				case CAIRO:
					...
					if (arabic == null)
					{
						arabic = new CairoTextArea("صِف خَلقَ خَودِ كَمِثلِ الشَمسِ إِذ بَزَغَت — يَحظى الضَجيعُ بِها نَجلاءَ مِعطارِ",
							Assets.getFont("assets/amiri-regular.ttf"), 16, RTL, ARABIC, "ar");
						english = new CairoTextArea("The quick brown fox jumps over the lazy dog.", Assets.getFont("assets/amiri-regular.ttf"), 16, LTR,
							COMMON, "en");
